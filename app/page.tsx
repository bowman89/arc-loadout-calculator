...
───────────────────────────────────── */}
      ...
      <section className="mx-auto max-w-6xl px-6 pt-24">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-4">
          ...
          <div
            className="relative overflow-hidden rounded-xl p-6 flex flex-col items-center text-center"
            style={{ backgroundColor: COLORS.darkCard }}
          >
            {/* New feature tag */}
            <div
    ...
    "
            ...
            <Search className="mb-4 h-6 w-6 text-accent" />
